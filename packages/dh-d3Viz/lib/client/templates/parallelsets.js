Template.parallelsets.rendered = function() {
    ...
    (function() {
        d3.parsets = function() {
            ...
            var width = $(".parallelsetsViz").parent().width(), 
    ...
    var vis = d3.select(".parallelsetsViz").append("svg")
        .attr("width", width)
        .attr("height", height);

    var csv = d3.csv.parse(this.data.d3Data);
    var dimensionVals = Papa.parse(this.data.d3Data).data[0]

    var chart = d3.parsets()
        .dimensions(dimensionVals);
